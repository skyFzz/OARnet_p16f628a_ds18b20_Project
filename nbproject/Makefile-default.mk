...
FINAL_IMAGE=${DISTDIR}/OARnet_thermo_as.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/OARnet_thermo_as.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16F628A
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/OARnet_thermo_as.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/OARnet_thermo_as.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16F628A ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/OARnet_thermo_as.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
